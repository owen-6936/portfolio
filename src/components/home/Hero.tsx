...
const Hero = () => {
  return (
    <section
      id="hero"
      className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-7xl mx-auto"
    >
      <motion.figure
        className="flex-shrink-0 rounded-lg w-[295px] md:w-[300px] overflow-hidden"
      ...
      >
        <img
          ...
          height="375"
          loading="lazy"
          className="rounded-lg shadow-md shadow-gray-500 w-full h-full object-cover scale-105"
        />
      </motion.figure>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <img src={checkIcon} alt="Checkmark icon" className="w-5 h-5" />
          <p className="text-sm text-gray-600">
            I'm actively seeking entry-level or junior development roles.
          </p>
        </div>
      </motion.div>
    </section>
